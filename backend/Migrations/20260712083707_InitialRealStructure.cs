        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Initiales = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParcoursNom = table.Column<string>(type: "text", nullable: false),
                    ...
                    Statut = table.Column<string>(type: "text", nullable: false),
                    VolumeCours = table.Column<int>(type: "integer", nullable: false),
                    VolumeTd = table.Column<int>(type: "integer", nullable: false),
                    VolumeTp = table.Column<int>(type: "integer", nullable: false),
                    VolumeProjet = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Couleur = table.Column<string>(type: "text", nullable: false),
                    ResponsableNom = table.Column<string>(type: "text", nullable: false),
                    ResponsablePrenom = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Equipements = table.Column<List<string>>(type: "text[]", nullable: false),
                    Statut = table.Column<string>(type: "text", nullable: false),
                    TauxOccupation = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: false),
                    Niveau = table.Column<string>(type: "text", nullable: false),
                    NbEtudiants = table.Column<int>(type: "integer", nullable: false),
                    OuvertConcours = table.Column<bool>(type: "boolean", nullable: false),
                    MentionId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
